...
public class PerformanceTest extends AbstractTestCase {
	...
	@Test
	public void serializeJdkTest() {
		ObjectSerializer objectSerializer = new JdkSerializationSerializer();
	...
	public void serializeJsonTest() {
		ObjectSerializer<Transaction> objectSerializer = new JsonTransactionSerializer();

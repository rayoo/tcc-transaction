...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`biz_a` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
/*Table structure for table `user_honour` */

DROP TABLE IF EXISTS `user_honour`;

CREATE TABLE `user_honour` (
  `user_id` bigint(20) NOT NULL COMMENT '用户ID',
  `honour_count` int(11) DEFAULT NULL COMMENT '荣耀数量',

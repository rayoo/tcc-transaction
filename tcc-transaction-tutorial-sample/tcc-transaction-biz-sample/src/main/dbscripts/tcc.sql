...
DROP TABLE IF EXISTS `tcc_transaction_biz`;

CREATE TABLE `tcc_transaction_biz` (
...
/*Table structure for table `tcc_transaction_biza` */

DROP TABLE IF EXISTS `tcc_transaction_biza`;

CREATE TABLE `tcc_transaction_biza` (
  `TRANSACTION_ID` int(11) NOT NULL AUTO_INCREMENT,
  `DOMAIN` varchar(100) DEFAULT NULL,
  `GLOBAL_TX_ID` varbinary(32) NOT NULL,
  `BRANCH_QUALIFIER` varbinary(32) NOT NULL,
...
/*Table structure for table `tcc_transaction_bizb` */

DROP TABLE IF EXISTS `tcc_transaction_bizb`;

CREATE TABLE `tcc_transaction_bizb` (
  `TRANSACTION_ID` int(11) NOT NULL AUTO_INCREMENT,
  `DOMAIN` varchar(100) DEFAULT NULL,
  `GLOBAL_TX_ID` varbinary(32) NOT NULL,
  `BRANCH_QUALIFIER` varbinary(32) NOT NULL,
